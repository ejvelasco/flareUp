...
function _treeBuilder(options, criterion, voter) {
  ...
  var node = {
    ...
    left: _treeBuilder((0, _utils._updateExamples)(options, split, 'left'), criterion, voter),
    right: _treeBuilder((0, _utils._updateExamples)(options, split, 'right'), criterion, voter),
