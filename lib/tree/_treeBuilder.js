...
function _treeBuilder(options, criterion, impurity, voter) {
  ...
  var splitImpurityDecrease = (0, _utils._impurityDecrease)(options, split, impurity);
  ...
  var nodeOptions = {
    ...
    left: _treeBuilder((0, _utils._updateParameters)(options, split['left'], depth), criterion, impurity, voter),
    right: _treeBuilder((0, _utils._updateParameters)(options, split['right'], depth), criterion, impurity, voter),
