...
var _extra_parameters = require('./extra_parameters');

var _extra_parameters2 = _interopRequireDefault(_extra_parameters);
...
var DecisionTreeClassifier = function (_DecisionTree) {
  ...
  _createClass(DecisionTreeClassifier, [{
    ...
    value: function fit(options) {
      var classifier = this;
      options = (0, _utils.set_defaults)(options, _defaults2.default);
      options = (0, _extra_parameters2.default)(options);
      (0, _index.each)(options, function (options, key) {
